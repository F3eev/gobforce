...
if __name__ == "__main__":
    ...
    parser.add_argument("-dp", "--dpath",  help="dir to nmap xml report")
    parser.add_argument("-f", "--fpath", help="path to nmap xml report")
    ...
    if args.dpath != None:
      for root, dirs, files in os.walk(args.dpath):
            for f in files:
